      ...
      <div className="fixed inset-0 flex flex-col items-center justify-center bg-background z-[9999] p-6 text-text">
        {!isStuck ? (
          ...
          <div className="bg-surface border border-border p-8 rounded-2xl max-w-sm w-full shadow-lg text-center">
            <div className="w-14 h-14 bg-danger/10 text-danger rounded-xl flex items-center justify-center mx-auto mb-4 text-2xl">!</div>
            ...
            <button 
              ...
              className="w-full py-2.5 bg-brand hover:bg-brand-hover text-white rounded-xl font-semibold text-sm transition-colors"
            >
              Retry
            </button>
          </div>
